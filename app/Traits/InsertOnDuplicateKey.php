...
trait InsertOnDuplicateKey
{
    ...
    public static function insertOnDuplicateKey(array $data, $table_name='', array $updateColumns = null )
    {
        if (empty($data)) {
            return false;
        }
        ...
        $sql = static::buildInsertOnDuplicateSql($data, $table_name, $updateColumns );
    ...
    */
     ...
     * @return string
     */
    protected static function buildInsertOnDuplicateSql(array $data, $table_name ,array $updateColumns = null)
    {
        $first = static::getFirstRow($data);
        $sql  = 'INSERT INTO `' . /*static::getTablePrefix() .*/ /*static::getTableName()*/$table_name . '`(' . static::getColumnList($first) . ') VALUES' . PHP_EOL;
