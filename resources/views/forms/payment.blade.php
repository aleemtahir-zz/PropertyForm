                            ...
                            <div class="statement">
                                <div class="c-number-integer c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12">
                                    <div class="c-label  "><label for="c-2-26">Sale Price</label></div>
                                        <div class="c-editor"><input name="monetary[price_i]" type="text" id="sale_price" placeholder="1,234,567.89" class="currency totalExpense"></div>
                                    <div class="c-validation"></div>
                                </div>
                                <div class="c-number-integer c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required">
                                    ...
                                    <div class="c-editor"><input name="monetary[cprice_i]" type="text" id="contract_price" placeholder="1,234,567.89" class="currency totalExpense"></div>
                                    <div class="c-validation">Contract Price is required.</div>
                                </div>
                                <div class="c-number-integer c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required">
                                    <div class="c-label  "><label for="c-4-24">Upgrades</label></div>
                                    <div class="c-editor"><input name="monetary[upgrade]" type="text" id="upgrades" placeholder="1,234,567.89" class="currency totalExpense"></div>
                                    <div class="c-validation">Upgrades is required.</div>
                                </div>
                                <div class="c-number-integer c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required">
                                    <div class="c-label  "><label for="c-5-23">½ Stamp Duty</label></div>
                                    <div class="c-editor"><input name="monetary[half_stamp_duty]" type="text" id="half_stamp_duty" placeholder="1,234,567.89" class="currency totalExpense"></div>
                                    <div class="c-validation">½ Stamp Duty is required.</div>
                                </div>
                                <div class="c-number-integer c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required">
                                    <div class="c-label  "><label for="c-6-22">½ Registration Fee</label></div>
                                    <div class="c-editor"><input name="monetary[half_reg_fee]" type="text" id="half_reg_fee" placeholder="1,234,567.89" class="currency totalExpense"></div>
                                    <div class="c-validation">½ Registration Fee is required.</div>
                                </div>
                                <div class="c-number-integer c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required">
                                    <div class="c-label  "><label for="c-7-21">½ Land Agreement Cost</label></div>
                                    <div class="c-editor"><input name="monetary[half_land_agreement]" type="text" id="half_land_agreement" placeholder="1,234,567.89" class="currency totalExpense"></div>
                                ...
                                <div class="c-number-integer c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required">
                                    ...
                                    <div class="c-editor"><input name="monetary[half_build_agreement]" type="text" id="half_build_agreement" placeholder="1,234,567.89" class="currency totalExpense"></div>
                                ...
                                <div class="c-number-integer c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required">
                                    ...
                                    <div class="c-editor"><input name="monetary[maintenance_expense]" type="text" id="maintenance_expense" placeholder="1,234,567.89" class="currency totalExpense"></div>
                                    <div class="c-validation">Maintenance Costs is required.</div>
                                </div>
                                <div class="c-number-integer c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required">
                                    <div class="c-label  "><label for="c-10-18">½ Title Costs</label></div>
                                    <div class="c-editor"><input name="monetary[half_title]" type="text" id="half_title_cost" placeholder="1,234,567.89" class="currency totalExpense"></div>
                                    <div class="c-validation">½ Title Costs is required.</div>
                                </div>
                                <div class="c-number-integer c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required">
                                    <div class="c-label  "><label for="c-11-17">Miscellaneous Expenses</label></div>
                                    <div class="c-editor"><input name="monetary[misc_expense]" type="text" id="misc_expense" placeholder="1,234,567.89" class="currency totalExpense"></div>
                                        ...
                                        <div class="c-repeating-section-container">
                                            ...
                                            <div class="c-repeating-section-item">
                                                ...
                                                <div class="c-currency c-field c-col-7 c-sml-col-7 c-span-6 c-sml-span-6">
                                                    ...
                                                    <div class="c-editor"><input type="text" id="c-13-15" name="expense[price][]" placeholder="1,234,567.89" class="currency totalExpense"></div>
                                                    <div class="c-validation"></div>
                                                </div>
                                            </div>
                                        </div>
